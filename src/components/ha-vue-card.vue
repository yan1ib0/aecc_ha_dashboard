<template>
  <div class="panel">
    ...
    <div class="content">
      <!-- 能流图 -->
      <div class="chart-container" style="padding-bottom: 0 !important; height: auto;">
        <div ref="energyFlowChart" class="chart" style="position: relative; height: auto;"></div>
      </div>
...
// 添加Web Component生命周期方法
const connectedCallback = () => {
  console.log('[ha-vue-card] Web Component已连接');
};

const disconnectedCallback = () => {
  console.log('[ha-vue-card] Web Component已断开连接');
};

const adoptedCallback = () => {
  console.log('[ha-vue-card] Web Component已被移动到新文档');
};
...
const updateCharts = () => {
  ...
  if (energyChart) {
    ...
    const containerHeight = energyFlowChart.value.clientHeight;
...
.chart-container:first-child .chart {
  position: relative;
  height: auto;
}
